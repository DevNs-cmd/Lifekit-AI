...
class AppTokens extends ThemeExtension<AppTokens> {
  ...
  @override
  AppTokens copyWith({
    Color? primary, Color? primaryHover, Color? primaryGlow,
    Color? primarySurface, Color? primarySurfaceFg,
    Color? accent, Color? accentFg,
    Color? background, Color? backgroundSubtle, Color? surface,
    Color? surfaceSecondary, Color? cardBg, Color? cardBorder,
    Color? textPrimary, Color? textSecondary, Color? textMuted,
    Color? textInverse, Color? border, Color? borderStrong,
    Color? destructive, Color? destructiveSurface,
    Color? warning, Color? warningSurface,
    Color? success, Color? successSurface,
    Color? info, Color? infoSurface,
    Color? priorityLowBg, Color? priorityLowFg,
    Color? priorityMedBg, Color? priorityMedFg,
    Color? priorityHighBg, Color? priorityHighFg,
    Color? priorityUrgentBg, Color? priorityUrgentFg,
    Color? statusActiveBg, Color? statusActiveFg,
    Color? statusActiveBorder,
    Color? statusPausedBg, Color? statusPausedFg,
    Color? statusPausedBorder,
    Color? statusDraftBg, Color? statusDraftFg,
  ...
  AppTokens lerp(AppTokens? other, double t) {
    ...
    return AppTokens(
      ...
      primarySurfaceFg: Color.lerp(primarySurfaceFg, other.primarySurfaceFg, t)!,
      ...
      destructiveSurface: Color.lerp(destructiveSurface, other.destructiveSurface, t)!,
      ...
      priorityUrgentBg: Color.lerp(priorityUrgentBg, other.priorityUrgentBg, t)!,
      priorityUrgentFg: Color.lerp(priorityUrgentFg, other.priorityUrgentFg, t)!,
      ...
      statusActiveBorder: Color.lerp(statusActiveBorder, other.statusActiveBorder, t)!,
      ...
      statusPausedBorder: Color.lerp(statusPausedBorder, other.statusPausedBorder, t)!,
      statusDraftBg: Color.lerp(statusDraftBg, other.statusDraftBg, t)!,
      statusDraftFg: Color.lerp(statusDraftFg, other.statusDraftFg, t)!,
      statusDraftBorder: Color.lerp(statusDraftBorder, other.statusDraftBorder, t)!,
