...
export class Task {
  @ApiProperty({ description: 'Unique identifier for the task', example: '123e4567-e89b-12d3-a456-426614174000' })
  id!: string;

  @ApiProperty({ description: 'Associated User ID', example: '123e4567-e89b-12d3-a456-426614174000' })
  userId!: string;

  @ApiProperty({ description: 'Associated Plan ID', example: '123e4567-e89b-12d3-a456-426614174000', required: false })
  planId?: string | null;

  @ApiProperty({ description: 'The title of the task', example: 'Buy new running shoes' })
  title!: string;

  @ApiProperty({ description: 'A detailed description of the task requirements', required: false, example: 'Ensure shoes are suitable for road running.' })
  ...
  @ApiProperty({ description: 'The individual or agent assigned to complete this task', required: false, example: 'User' })
