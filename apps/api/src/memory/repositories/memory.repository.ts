...
export class MemoryRepository implements IMemoryRepository {
  ...
  async findUserMemories(userId: string, pagination?: PaginationParams): Promise<PaginatedResult<Memory>> {
    try {
  ...
  async updateMemory(id: string, data: UpdateMemoryDto): Promise<Memory> {
    try {
      ...
      if (data.contextInfo !== undefined) updateData.contextInfo = data.contextInfo;
