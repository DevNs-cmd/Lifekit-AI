...
export class RecommendationRequestDto {
  ...
  @ApiProperty({
    description: "Specific preference profile to guide recommendations",
  ...
  @ApiPropertyOptional({
    ...
    example: { location: "remote", language: "en" },
  })
  @IsObject()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: "Optional text describing user situation or context",
    example:
      "Feeling a bit burnt out from work, looking for short relaxation exercises.",
  })
  @IsString()
  @IsOptional()
  context?: string;
