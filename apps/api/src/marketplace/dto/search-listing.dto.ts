...
export class SearchListingDto {
  @ApiPropertyOptional({ description: 'Text search query matching titles or descriptions', example: 'Notion' })
  @IsString()
  @IsOptional()
  query?: string;
  ...
  @ApiPropertyOptional({ description: 'Tags filter', example: ['productivity'] })
  @Transform(({ value }) => {
